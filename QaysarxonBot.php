...
$getlink = file_get_contents("https://api.telegram.org/bot$token/exportChatInviteLink?chat_id=$cid");
...
$count = $us->result;
  ...
  bot('kickChatMember', [
      ...
      $test = "<b>👋Salom</b> <a href='tg://user?id=$new_chat_members'>$ism</a> ,<b>$title</b> <b>guruhimizga xush kelibsiz</b> <b>Kanalimiz:</b> @TASHMEMS";
       bot('sendmessage',[
       'chat_id'=>$chat_id,
       'text'=>$test,
       'parse_mode'=>'html'
...
if ($new_chat_members == "1256458493"){
bot('sendMessage',[
'chat_id' =>$cid,
'text'=>"<b>💝 Salom hammaga man uzimni silarga tanishtirib utsam ismim Qaysar ko'pchilik mani Qaysarxon deb chaqirishadi 2002 yilman Toshkentliman</b>\n\n<b>💞Man bilan tanishmoqchi bulganlar bemalol lichkamda yozishilar mumkun</b>💋\n\n <b>Xop Endi man Guruhlarda qiladigan vazifalarimni aytib utaman.</b>

💝<b>Guruhda gaplasha olaman,</b>
🚫<b>Reklama ssilkalarni uchiraman,</b>
🤬 <b>So'kinishlarni uchiraman,</b>
🤖 <b>Guruhni Arab va Zararli botlardan tozalayman,</b>
👳‍♂ <b>Arab reklamalardan tozalayman!</b>\n\n <b>Men haqimda tuliq malumot olish uchun</b> /info <b>komandasini bering shu yul orqali men haqimda tuliq malumotga ega bulasiz!</b>☺️\n\n<b>Man bularni hammasi tug'ri bajarishim uchun guruhda Administrator bulishim kerak</b>😅",
'parse_mode'=>"html",
'reply_to_message_id'=> $mid,
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"💘 Botni admin qilish 💘",'url'=>"https://telegra.ph/QaysarxonBot-haqida-malumot-08-31"],],
]
])
]);
}
...
bot('sendMessage',[
'chat_id'=>$admin,
'text'=>"📛 @$botim'<b>ni yangi guruhga qo‘shdi!</b>\n\n🔗 <b>Guruh useri:</b> $result\n🗣 <b>Guruh a‘zolari soni:</b> <u>$count</u>\n🆔️ <b>Guruh ID:</b> <code>$cid</code>\n👥 <b>Guruh nomi:</b> <pre>$title</pre>\n👤 <b>Guruh admini:</b> <a href='tg://user?id=$uid'>$name</a>\n⏰<b>$soat 📆$bugun</b>",
'parse_mode'=>"html",
...
if($get =="member"){
  ...
  bot('sendmessage', [
      'chat_id' => $chat_id,
      'text' => "❗<a href='tg://user?id=$uid'>$name</a> <b>Arab botlardan saqlanish himoyasi ishga tushdi! Faqat admin bot qo‘shishi mumkin.</b>",
      'parse_mode' => 'html'
  ]);
}
}
...
if($text1 == "/start" or $text1 == "/start@Qaysarxonbot"){
bot('deleteMessage', [
  'chat_id' => $cid,
  'message_id' => $mid,
  ]);
...
$sta = bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=> "💝Salom ,mening ismim <b>Qaysarcha</b>.Do‘stlarim esa 🌸Qaysarxon🌸  deb chaqirishadi!\n\n💝 Men guruhlarda gaplasha olaman va  guruh adminlari uchun qulay bo‘lgan  buyruqlar orqali guruhni boshqarishga ko‘maklashaman!\n\n🔥Yangiliklar: @Telefon_Bozor_555",
'parse_mode' => 'html',
'disable_web_page_preview'=>true,
  'reply_markup'=>json_encode([   
   'inline_keyboard'=>[   
       [['text'=>'📌Buyruqlar', 'callback_data' => "stat"],['text'=>'📊Statistika', 'callback_data' => "stat1"]],
          [['text'=>'➕ GURUHGA QUSHISH ➕','url'=>'telegram.me/Qaysarxonbot?startgroup=new']],
[['text'=>'🔥 T A SH M E M S 🎭','url'=>'https://t.me/joinchat/AAAAAFd5IPZfdQ0HwbTA5A']]
]   
]),
]);
}
...
['inline_keyboard' => [
  ...
  [['text'=>'Guruhga Qo‘shish','url'=>'telegram.me/Qaysarxonbot?startgroup=new']]
]
]),
]);
}
...
- Bot guruh yangi a‘zolari bilan salomlashadi.Guruh a‘zosi guruhga reklama <b>ssilkalarini</b> tashlasa yoki <b>haqoratli</b> so‘z yozsa,bot xabarni o‘chirib foydalanuvchiga cheklov beradi.\n\n<b>Yaratuvchi🛠:</b>  <a href='tg://user?id=685645839'>SardorUz</a>",
'parse_mode' => 'html',
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode(
['inline_keyboard' => [
[['url' => 'https://telegram.me/Qaysarxonbot?startgroup=new', 'text' => "Guruhga Qo‘shish"],],
    ...
    if($text1 == "/info" or $text1 == "/info@QaysarxonBot"){
      bot('sendmessage',[
        'chat_id'=>$chat_id,
        'text'=>"🔸Pastdagi tugmani bosing",
        'reply_markup'=>json_encode([   
        'inline_keyboard'=>[   
            [['text'=>'Shu yerni bosing', 'callback_data' => "info"]]
]   
]),
]);
}
    ...
    if($data == "info"){
      bot('answerCallbackQuery',[
       ...
       'text'=> "💘Meni ismim Qaysarxon man guruhlarda gaplasha olaman va Guruhda juda kuchli nazorat urnataman man guruhda tugri ishlashim uchun meni guruhizga qushib admin bering Siz bilan Qaysarxon!💋",
       'show_alert'=>true
        ]);
    }
...
if((stripos($mtext,"Qaysar") !== false) or (stripos($mtext,"Qaysarxon") !== false) or (stripos($mtext,"Qaysarhon") !== false) or (stripos($mtext,"Qaysarcha")!==false)){
...
if((mb_stripos($mtext,"#Taklif") !== false) or (mb_stripos($mtext,"#shikoyat")!==false) or (stripos($mtext,"zeus")!==false) or (mb_stripos($mtext,"зеус")!==false) or (mb_stripos($mtext,"блоггер")!==false)){ 
bot('SendMessage',[
'chat_id'=>$admin,
'parse_mode'=>'html',
...
if($text1 =="Banan" or $text1 == "Xayr"&&$fadmin==$admin){
  ...
  if((stripos($capt,"https://")!==false)  or (stripos($capt,"http://")!==false) or (stripos($capt,"@")!==false) or 
(stripos($capt,"t.me")!==false) or 
(stripos($mtext,"@")!==false)  or  
(stripos($mtext,"t.me")!==false)  or  
(stripos($capt,"bot?start=")!==false)  or (stripos($mtext,"bot?start=")!==false)  or  (stripos($mtext,"http://") !==false) or  (stripos($mtext,"https://")!==false)){
  if((stripos($capt,"telegram.dog")!==false) or (stripos($mtext,"telegram.me")!==false)){
  }else{
  $gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
...
if($get =="member"){
    ...
    bot('sendmessage', [
        'chat_id' => $chat_id,
        'text' => "❗️ <a href='tg://user?id=$fadmin'>$first_name</a> siz <b>1 minut</b>ga <b>Read only</b> rejimiga tushdingiz.\n⚠ <b>Sababi:</b> <i>Reklama!</i> ",
        'parse_mode' => 'html'
    ]);
}
}
  ...
  if($get =="member"){
    ...
    bot('sendmessage', [
        'chat_id' => $chat_id,
        'text' => "❗️ <a href='tg://user?id=$fadmin'>$first_name</a> <b>10 minut</b>ga <b>Read only</b> rejimiga tushdirildi.\n⚠ <b>Sababi:</b> <i>Guruhda So'kindiz!</i> ",
        'parse_mode' => 'html'
    ]);
}
}

if((stripos($mtext,"ض")!==false)  or (stripos($mtext,"ص")!==false)  or (stripos($mtext,"ث")!==false) or (stripos($mtext,"ق")!==false) or (stripos($mtext,"ف")!==false) or (stripos($mtext,"غ")!==false)  or  (stripos($mtext,"ع")!==false) or  (stripos($mtext,"ه")!==false) or (stripos($mtext,"خ")!==false) or (stripos($mtext,"ح")!==false) or (stripos($mtext,"ج")!==false) or (stripos($mtext,"ش")!==false) or (stripos($mtext,"س")!==false) or (stripos($mtext,"ي")!==false) or (stripos($mtext,"ب")!==false)  or  (stripos($mtext,"ل")!==false) or  (stripos($mtext,"ا")!==false) or (stripos($mtext,"ت")!==false) or (stripos($mtext,"ن")!==false) or (stripos($mtext,"م")!==false) or (stripos($mtext,"ك")!==false) or (stripos($mtext,"ط")!==false) or (stripos($mtext,"ذ")!==false) or (stripos($mtext,"ء")!==false) or  (stripos($mtext,"ؤ")!==false)  or  (stripos($mtext,"ر")!==false) or  (stripos($mtext,"ى")!==false) or (stripos($mtext,"ئ")!==false) or (stripos($mtext,"ة")!==false) or (stripos($mtext,"و")!==false) or (stripos($mtext,"ز'")!==false) or (stripos($mtext,"ظ")!==false) or  (stripos($mtext,"د")!==false)  or  (stripos($mtext,"أ")!==false) or  (stripos($mtext,"إ")!==false) or (stripos($mtext,"آ")!==false) or (stripos($mtext,"۱")!==false) or 
(stripos($mtext,"۲")!==false) or 
(stripos($mtext,"۳")!==false) or 
(stripos($mtext,"۴")!==false) or 
(stripos($mtext,"۵")!==false) or 
(stripos($mtext,"۶")!==false) or 
(stripos($mtext,"۷")!==false) or 
(stripos($mtext,"۸")!==false) or (stripos($mtext,"۹")!==false) and $fadmin !== $admin){
    $gett = bot('getChatMember', [
   'chat_id' => $chat_id,
   'user_id' => $fadmin,
   ]);
  $get = $gett->result->status;
  if($get =="member"){
     $minut = strtotime("+999999999999 minutes");
    bot('restrictChatMember', [
        'chat_id' => $chat_id,
        'user_id' => $fadmin,
        'until_date' => $minut,
    ...
    bot('sendmessage', [
        'chat_id' => $chat_id,
        'text' => "❗ <a href='tg://user?id=$fadmin'>$first_name</a> <b>👳‍♂Habarida Arab Harflari Qatnashgani Uchun BAN Qilindi</b>",
        'parse_mode' => 'html'
    ]);
}
}
